...
urlbase = "http://127.0.0.1:8509/canal/get_feature_count?bizid=5&citylist=1&minute="+timestamp+"&iscarpool=1&dpnormal=1"
urltest = "http://127.0.0.1:8508/canal/get_feature_count?bizid=5&citylist=1&minute="+timestamp+"&iscarpool=1&dpnormal=1"

print ("--get_feature_count_abnormal diff start bizid=5,cityid=1,minute=%s--"%timestamp)
...
if (basejson['errno']!=0 ):
    ...
    sys.exit(1)
base = basejson['data']
basedata = base["1"]["productfeature"]["5"]
...
if (testjson['errno']!=0 ):
    ...
    sys.exit(1)
test = testjson['data']
testdata =  test["1"]["productfeature"]["5"]
