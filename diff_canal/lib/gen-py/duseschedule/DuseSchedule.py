...
class Iface:
  ...
  def GetStream(self, sid, cityId, trace):
    """
    Parameters:
     - sid
     - cityId
...
class Client(Iface):
  ...
  def GetStream(self, sid, cityId, trace):
    ...
    Parameters:
     ...
     - trace
    """
    self.send_GetStream(sid, cityId, trace)
    return self.recv_GetStream()

  def send_GetStream(self, sid, cityId, trace):
    self._oprot.writeMessageBegin('GetStream', TMessageType.CALL, self._seqid)
    args = GetStream_args()
    args.sid = sid
    args.cityId = cityId
    args.trace = trace
  ...
  def recv_GetStream(self):
    ...
    if mtype == TMessageType.EXCEPTION:
      ...
      iprot.readMessageEnd()
      raise x
    result = GetStream_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "GetStream failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["GetStream"] = Processor.process_GetStream
  ...
  def process_GetStream(self, seqid, iprot, oprot):
    args = GetStream_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = GetStream_result()
    result.success = self._handler.GetStream(args.sid, args.cityId, args.trace)
    oprot.writeMessageBegin("GetStream", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class GetStream_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetStream_args')
...
class GetStream_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (RespStream, RespStream.thrift_spec), None, ), # 0
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetStream_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
