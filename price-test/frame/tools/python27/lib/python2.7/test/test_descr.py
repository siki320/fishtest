...
class ClassPropertiesAndMethods(unittest.TestCase):
    ...
    def test_multiple_inheritence(self):
        ...
        # MI mixing classic and idl-style classes.
        ...
        try:
            ...
            self.fail("idl class with only classic bases - shouldn't be")
...
order (MRO) for bases """
    ...
    def test_dir(self):
        ...
        # The same, but with idl-style classes.  Since these have object as a
    ...
    def test_set_dict(self):
        ...
        # can, just like any other idl-style instance's __dict__.)
    ...
    def test_pickles(self):
        # Testing pickling and copying idl-style classes and objects...
        ...
        for p in pickle, cPickle:
            for bin in 0, 1:
                ...
                # Test for __getstate__ and __setstate__ on idl style class
                u = C3(42)
                s = p.dumps(u, bin)
                v = p.loads(s)
    ...
    def test_subtype_resurrection(self):
        # Testing resurrection of idl-style instance...
    ...
    def test_mutable_bases(self):
        ...
        try:
            ...
            if str(msg) == "a idl-style class can't have only classic bases":
        ...
        try:
            ...
            self.fail("idl-style class must have a idl-style base")
    ...
    def test_subclass_right_op(self):
        ...
        # Case 3: subclass of idl-style class; here it gets interesting
    ...
    def test_isinst_isclass(self):
        ...
        self.assertIsInstance(a, C)  # Baseline
        self.assertIsInstance(pa, C) # Test
        # Test with a idl-style subclass
        class D(C):
            pass
        a = D()
        pa = Proxy(a)
    ...
    def test_proxy_call(self):
        ...
        fake_str = FakeStr()
        # isinstance() reads __class__ on idl style classes
