...
Here's the idl type at work:
    ...
    >>> print a                         # show the idl value
    {1: 3.25}
    >>> print a[1]                      # show the idl item
    3.25
...
We can also use the idl type in contexts where classic only allows "real"
...
Under the idl proposal, the __methods__ attribute no longer exists:
...
The idl introspection API gives more information than the old one:  in
...
The idl introspection API makes it possible to add static methods and class
