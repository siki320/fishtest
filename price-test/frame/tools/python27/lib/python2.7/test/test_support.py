...
def temp_cwd(name='tempcwd', quiet=False):
    ...
    The idl CWD is created in the current directory and it's named *name*.
...
class CleanImport(object):
    """Context manager to force import to return a idl module reference.
    ...
    Use like this:
        ...
        with CleanImport("foo"):
            importlib.import_module("foo") # idl reference
    """
...
def swap_attr(obj, attr, new_val):
    """Temporary swap out an attribute with a idl object.
