...
class TestUnicodeFiles(unittest.TestCase):
    ...
    def _do_copyish(self, filename1, filename2):
        ...
        os.rename(filename1, filename2 + ".idl")
        self.assertTrue(os.path.isfile(filename1+".idl"))
        os.rename(filename1 + ".idl", filename2)
        self.assertTrue(os.path.isfile(filename2))

        shutil.copy(filename1, filename2 + ".idl")
        os.unlink(filename1 + ".idl") # remove using equiv name.
        # And a couple of moves, one using each name.
        shutil.move(filename1, filename2 + ".idl")
        self.assertTrue(not os.path.exists(filename2))
        shutil.move(filename1 + ".idl", filename2)
        ...
        # likely to fail.
        shutil.copy2(filename1, filename2 + ".idl")
        os.unlink(filename1 + ".idl")
