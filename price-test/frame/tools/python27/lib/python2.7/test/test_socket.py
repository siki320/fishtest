...
class ThreadableTest:
    ...
    idl threaded class from an existing unit test, use multiple
    inheritance:

        class NewClass (OldClass, ThreadableTest):
            pass

    This class defines two idl fixture functions with obvious
    purposes for overriding:

        clientSetUp ()
        clientTearDown ()

    Any idl test functions within the class must then define
...
class UnbufferedFileObjectClassTestCase(FileObjectClassTestCase):
    ...
    def testUnbufferedReadline(self):
        # Read a line, create a idl file object, read another line with it
