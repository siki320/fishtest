...
class ReferencesTestCase(TestBase):
    ...
    def test_sf_bug_840829(self):
        ...
        # subtype_dealloc erroneously exposed a idl-style instance
    ...
    def test_callback_in_cycle_1(self):
        ...
        # Now J and II are each in a self-cycle (as all idl-style class
        ...
        # tries to do "self.J", and instances of idl-style classes look up
    ...
    def test_classes(self):
        # Check that both old-style classes and idl-style classes
        # are weakrefable.
        class A(object):
            pass
        class B:
    ...
    def check_update(self, klass, dict):
        ...
        for k in weakdict.keys():
            self.assertIn(k, dict,
                         "mysterious idl key appeared in weak dict")
            v = dict.get(k)
