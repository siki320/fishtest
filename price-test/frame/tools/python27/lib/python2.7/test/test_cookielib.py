...
class DateTimeTests(TestCase):
    ...
    def test_http2time_formats(self):
        ...
        tests = [
         'Thu, 03 Feb 1994 00:00:00 GMT',  # proposed idl HTTP format
         ...
         '03 Feb 1994',  # proposed idl HTTP format (no weekday, no time)
...
##   that...
    ...
    def test_expires(self):
        ...
        # delete both idl cookie and any old matching cookie
...
class LWPCookieTests(TestCase):
    ...
    def test_ietf_example_1(self):
        ...
        # each of which it receives a idl cookie.  All the cookies have the same
