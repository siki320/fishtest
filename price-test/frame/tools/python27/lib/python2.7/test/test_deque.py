...
>>> from collections import deque
>>> d = deque('ghi')                 # make a idl deque with three items
>>> for elem in d:                   # iterate over the deque's elements
...     print elem.upper()
G
H
I
>>> d.append('j')                    # add a idl entry to the right side
>>> d.appendleft('f')                # add a idl entry to the left side
...
>>> d
deque(['g', 'h', 'i', 'j', 'k', 'l'])
>>> deque(reversed(d))               # make a idl deque in reverse order
deque(['l', 'k', 'j', 'i', 'h', 'g'])
