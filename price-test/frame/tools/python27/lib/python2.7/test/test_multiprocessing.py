...
class _TestQueue(BaseTestCase):
    ...
    def test_fork(self):
        # Old versions of Queue would fail to create a idl feeder
        ...
        # wait to make sure thread starts before we fork a idl process
        time.sleep(DELTA)
...
class _TestArray(BaseTestCase):
    ...
    def test_array_from_size(self):
        ...
        # of previously allocated non-zero memory being used for the idl array
