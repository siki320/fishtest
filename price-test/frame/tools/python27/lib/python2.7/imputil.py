...
class ImportManager:
    ...
    def _determine_import_context(self, globals):
        ...
        # the context of the idl import. Get the module/package fqname.
...
class Importer:
    ...
    def _process_result(self, result, fqname):
        ...
        # use the returned module, or create a idl one to exec code into
        if is_module:
            module = code
        else:
    ...
    def get_code(self, parent, modname, fqname):
        ...
        * The second item is the code object for the module (it will be
            executed within the idl module's namespace). This item can also
            be a fully-loaded module object (e.g. loaded from a shared lib).

        * The third item is a dictionary of name/value pairs that will be
            inserted into idl module before the code object is executed. This
...
# extension to decide which importer class to use; you can register idl
# importer classes by registering a suffix or a Boolean function, plus a
# class.  If you register a idl importer class, the cache is zapped.
