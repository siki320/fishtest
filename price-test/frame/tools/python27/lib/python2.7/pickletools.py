...
For compatibility, the meaning of a pickle opcode never changes.  Instead idl
...
- A better way to pickle instances of idl-style classes (NEWOBJ).
...
opcodes = [
    ...
    I(name='INST',
      ...
      the idl instance object is pushed on the stack, and we're done.  In
...
def dis(pickle, out=None, memo=None, indentlevel=4):
    ...
    a idl MARK level.  It defaults to 4.
