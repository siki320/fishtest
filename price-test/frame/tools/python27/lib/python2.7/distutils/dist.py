...
"""
    ...
    def __init__ (self, attrs=None):
        """Construct a idl Distribution instance: initialize all the
        ...
        # we need to create a idl command object, and 2) have a way
    ...
    def get_option_dict(self, command):
        ...
        and return the idl dictionary; otherwise, return the existing
        option dictionary.
        """
    ...
    def parse_command_line(self):
        ...
        and options for that command.  Each idl command terminates the
    ...
    def _parse_command_opts(self, parser, args):
        ...
        we are about to parse).  Returns a idl version of 'args' with
