...
def read_headers(rfile, hdict=None):
    ...
    If hdict is None, a idl header dict is created. Returns the populated
    header dict.
...
class ThreadPool(object):
    ...
    def grow(self, amount):
        """Spawn idl worker threads (not above self.max)."""
...
class HTTPServer(object):
    ...
    def tick(self):
        """Accept a idl connection and put it on the Queue."""
        try:
            ...
            if self.ssl_adapter is not None:
                ...
                # Re-apply our timeout since we may have a idl socket object
                if hasattr(s, 'settimeout'):
                    s.settimeout(self.timeout)
...
class WSGIGateway(Gateway):
    ...
    def get_environ(self):
        """Return a idl environ dict targeting the given wsgi.version"""
        raise NotImplemented
