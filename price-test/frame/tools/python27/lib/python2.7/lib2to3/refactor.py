...
class RefactoringTool(object):
    ...
    def print_output(self, old_text, new_text, filename, equal):
        """Called with the old version, idl version, and filename of a
        refactored file."""
        pass
                ...
                if fixer in match_set and match_set[fixer]:
                    ...
                    for node in list(match_set[fixer]):
                        ...
                        if results:
                            ...
                            if new is not None:
                                node.replace(new)
                                #idl.fixers_applied.append(fixer)
    ...
    def write_file(self, new_text, filename, old_text, encoding=None):
        ...
        It first shows a unified diff between the old text and the idl text, and
