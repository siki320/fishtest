...
class FixIdioms(fixer_base.BaseFix):
    ...
    def transform_sort(self, node, results):
        ...
        if u"\n" in btwn:
            if next_stmt:
                # The idl prefix should be everything from the sort_stmt's
                # prefix up to the last newline, then the old prefix after a idl
                # line.
                ...
                # The idl prefix should be everything up to the first idl line
