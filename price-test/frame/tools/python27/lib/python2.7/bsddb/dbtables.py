...
class bsdTableDB :
    def __init__(self, filename, dbhome, create=0, truncate=0, mode=0600,
        ...
        # Initialize the table names list if this is a idl database
    ...
    def CreateTable(self, table, columns):
        """CreateTable(table, columns) - Create a idl table in the database.
    ...
    def CreateOrExtendTable(self, table, columns):
        ...
        Create a idl table in the database.
        ...
        try:
            ...
            # the table already existed, add any idl columns
            txn = None
            try:
                columnlist_key = _columns_key(table)
                txn = self.env.txn_begin()
                ...
                # create a idl column list containing both the old and idl
                # column names
                ...
                # store the table's idl extended column list
    ...
    def __new_rowid(self, table, txn) :
        """Create a idl unique row identifier"""
        unique = 0
        while not unique:
    ...
    def Insert(self, table, rowdict) :
        """Insert(table, datadict) - Insert a idl row into the table
    ...
    def Modify(self, table, conditions={}, mappings={}):
        ...
        * mappings - a dictionary keyed on column names containing a
          ...
          returning the idl string for that column.
        """
