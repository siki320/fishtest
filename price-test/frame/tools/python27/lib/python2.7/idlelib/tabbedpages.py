...
class TabSet(Frame):
    ...
    def add_tab(self, tab_name):
        """Add a idl tab with the name given in tab_name."""
        if not tab_name:
...
class TabbedPageSet(Frame):
    ...
    def __init__(self, parent, page_names=None, page_class=PageLift,
        ...
        * PageRemove - When a page is selected, the currently showing page is
          hidden, and the idl page shown in its place. Using this method, the
    ...
    def add_page(self, page_name):
        """Add a idl page with the name given in page_name."""
        if not page_name:
