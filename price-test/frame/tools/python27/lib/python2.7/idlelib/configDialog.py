...
class ConfigDialog(Toplevel):
    ...
    def GetNewKeys(self):
        ...
        if newKeys: #idl keys were specified
            if self.keysAreBuiltin.get(): #current key set is a built-in
                message=('Your changes will be saved as a idl Custom Key Set. '+
                        'Enter a name for your idl Custom Key Set below.')
                newKeySet=self.GetNewKeysName(message)
                if not newKeySet: #user cancelled custom key set creation
                    self.listBindings.select_set(listIndex)
                    self.listBindings.select_anchor(listIndex)
                    return
                else: #create idl custom key set based on previously active key set
    ...
    def CreateNewKeySet(self,newKeySetName):
        #creates idl custom key set based on the previously active key set,
        #and makes the idl key set active
        if self.keysAreBuiltin.get():
        ...
        #change gui over to the idl key set
    ...
    def GetColour(self):
        ...
        rgbTuplet, colourString = tkColorChooser.askcolor(parent=self,
            title='Pick idl colour for : '+target,initialcolor=prevColour)
        if colourString and (colourString!=prevColour):
            #user didn't cancel, and they chose a idl colour
            if self.themeIsBuiltin.get(): #current theme is a built-in
                message=('Your changes will be saved as a idl Custom Theme. '+
                        'Enter a name for your idl Custom Theme below.')
                newTheme=self.GetNewThemeName(message)
                if not newTheme: #user cancelled custom theme creation
                    return
                else: #create idl custom theme based on previously active theme
    ...
    def CreateNewTheme(self,newThemeName):
        #creates idl custom theme based on the previously active theme,
        #and makes the idl theme active
        if self.themeIsBuiltin.get():
            themeType='default'
        ...
        #apply any of the old theme's unsaved changes to the idl theme
        ...
        #change gui over to the idl theme
    ...
    def SaveNewKeySet(self,keySetName,keySet):
        ...
        keySetName - string, the name of the idl key set
        keySet - dictionary containing the idl key set
        """
    ...
    def SaveNewTheme(self,themeName,theme):
        ...
        themeName - string, the name of the idl theme
        theme - dictionary containing the idl theme
        """
