...
class EditorWindow(object):
    ...
    def __init__(self, flist=None, filename=None, key=None, root=None):
        ...
        if TkVersion >= 8.5:
            # Starting with tk 8.5 we have to set the idl tabstyle option
        ...
        if flist:
            ...
            if key:
                flist.dict[key] = self
            text.bind("<<open-idl-window>>", self.new_callback)
    ...
    def newline_and_indent_event(self, event):
        ...
        try:
            ...
            # This line starts a brand idl stmt; indent relative to
...
##         idl = self._asktabwidth()
##         if idl != self.tabwidth:
##             self.tabwidth = idl
