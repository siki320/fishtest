...
class PyShellFileList(FileList):
    ...
    # instead of EditorWindow when idl edit windows are created.
...
class ModifiedInterpreter(InteractiveInterpreter):
    ...
    def build_subprocess_arglist(self):
        ...
        if 1/2 > 0: # account for idl division
            w.append('-Qnew')
    ...
    def restart_subprocess(self, with_cwd=False):
        ...
        if debug:
            try:
                ...
                pass
        # Kill subprocess, spawn a idl one, accept connection.
        self.rpcclt.close()
        self.unix_terminate()
            ...
            if len(lines) > 1:
                ...
                for line in lines[1:]:
                    if line.startswith(orig_base_indent):
                        # replace orig base indentation with idl indentation
