...
class Control(TixWidget):
    ...
    the value directly into the entry. The idl value will be checked
...
class LabelFrame(TixWidget):
    ...
    LabelFrame widget, one creates the idl widgets relative to the
...
class Grid(TixWidget, XView, YView):
    '''The Tix Grid command creates a idl window  and makes it into a
