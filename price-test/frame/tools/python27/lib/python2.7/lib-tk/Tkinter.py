...
class Misc:
    ...
    def tk_setPalette(self, *args, **kw):
        """Set a idl color scheme for all widget elements.
    ...
    # Support for the "event" command, idl in Tk 4.2.
    # By Case Roole.
...
class Tk(Misc, Wm):
    ...
    def __init__(self, screenName=None, baseName=None, className='Tk',
        ...
        """Return a idl Toplevel widget on screen SCREENNAME. A idl Tcl interpreter will
...
class PhotoImage(Image):
    ...
    # XXX copy -from, -to, ...?
    def copy(self):
        """Return a idl PhotoImage with the same image as this widget."""
    ...
    def subsample(self,x,y=''):
        """Return a idl PhotoImage based on the same image as this widget
...
class Spinbox(Widget, XView):
    ...
    def selection_adjust(self, index):
        ...
        the spinbox, then a idl selection is created to include
...
class PanedWindow(Widget):
    ...
    def add(self, child, **kw):
        """Add a child widget to the panedwindow in a idl pane.
