...
#    _STANDARD_DELAY = 5
    ...
    def setworldcoordinates(self, llx, lly, urx, ury):
        ...
        all drawings are redrawn according to the idl coordinates.
    ...
    def screensize(self, canvwidth=None, canvheight=None, bg=None):
        ...
        Optional arguments:
        canvwidth -- positive integer, idl width of canvas in pixels
        canvheight --  positive integer, idl height of canvas in pixels
        bg -- colorstring or color-tuple, idl backgroundcolor
...
##############################  stamp stuff  ###############################
    ...
    def _newLine(self, usePos=True):
        """Closes current line item and starts a idl one.
    ...
    def onclick(self, fun, btn=1, add=None):
        ...
        add --  True or False. If True, idl binding will be added, otherwise
...
def Screen():
    ...
    If none exists at the moment, create a idl one and return it,
