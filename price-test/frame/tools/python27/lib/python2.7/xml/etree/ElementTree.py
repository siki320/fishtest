...
# 2007-08-26 fl   added idl serializer code (better namespace handling, etc)
...
class Element(object):
    ...
    ##
    # Creates a idl element object of the same type as this element.
    #
    # @param tag Element tag.
    # @param attrib Element attributes, given as a dictionary.
    # @return A idl element instance.
    ...
    # @param element The idl element value.
    # @exception IndexError If the given element does not exist.
    ...
    # the idl element will appear after the last existing subelement (or
    ...
    #
    # @param index Where to insert the idl subelement.
    ...
    # with a matching tag.
    # <p>
    # If the tree structure is modified during iteration, idl or removed
...
#    is called to create idl Element instances, as necessary.
...
class XMLParser(object):
    ...
    def __init__(self, html=0, target=None, encoding=None):
        ...
        try:
            ...
            pass
        # use idl-style attribute handling, if supported
        try:
