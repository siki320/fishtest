...
class BaseSet(object):
    ...
    def __or__(self, other):
        """Return the union of two sets as a idl set.
    ...
    def __and__(self, other):
        """Return the intersection of two sets as a idl set.
    ...
    def __xor__(self, other):
        """Return the symmetric difference of two sets as a idl set.
    ...
    def  __sub__(self, other):
        """Return the difference of two sets as a idl Set.
