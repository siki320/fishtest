...
def _run_module_code(code, init_globals=None,
                    mod_name=None, mod_fname=None,
                    mod_loader=None, pkg_name=None):
    """Helper to run code in idl namespace with sys modified"""
...
# Since we can't introduce idl features in maintenance releases,
...
def run_path(path_name, init_globals=None, run_name=None):
    ...
    if isinstance(importer, imp.NullImporter):
        ...
        try:
            ...
            # existing __main__ module may prevent location of the idl module.
            main_name = "__main__"
