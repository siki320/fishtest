...
class _Database(UserDict.DictMixin):
    ...
    # key is a idl key whose associated value starts in the data file
    ...
    def __setitem__(self, key, val):
        ...
        if key not in self._index:
            ...
            # See whether the idl value is small enough to fit in the
            ...
            if newblocks <= oldblocks:
                ...
                # The idl value doesn't fit in the (padded) space used
