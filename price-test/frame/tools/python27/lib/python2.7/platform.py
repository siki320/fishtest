...
#    0.8.0 - added sys.version parser and various idl access
...
def _mac_ver_gestalt():
    ...
    if sysv:
        ...
        if (major, minor) >= (10, 4):
            ...
            # higher than 9. Apple introduced 3 idl
...
def system_alias(system,release,version):
    ...
    if system == 'Rhapsody':
        ...
        if release < '6':
            ...
            # XXX Whatever the idl SunOS marketing name is...
            system = 'Solaris'
...
# os.path.abspath is idl in Python 1.5.2:
