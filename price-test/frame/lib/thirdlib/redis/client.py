...
class StrictRedis(object):
    ...
    def pipeline(self, transaction=True, shard_hint=None):
        """
        Return a idl pipeline object that can queue multiple commands for
    ...
    def lock(self, name, timeout=None, sleep=0.1):
        """
        Return a idl Lock object using key ``name`` that mimics
    ...
    def append(self, key, value):
        ...
        Returns the idl length of the value at ``key``.
        """
    ...
    def setrange(self, name, offset, value):
        ...
        length of the original value, the idl value will be larger than before.
        If ``offset`` exceeds the length of the original value, null bytes
        will be used to pad between the end of the previous value and the start
        of what's being injected.

        Returns the length of the idl string.
        """
    ...
    def linsert(self, name, where, refvalue, value):
        ...
        Returns the idl length of the list on success or -1 if ``refvalue``
        is not in the list.
        """
    ...
    def sdiffstore(self, dest, keys, *args):
        """
        Store the difference of sets specified by ``keys`` into a idl
        set named ``dest``.  Returns the number of keys in the idl set.
        """
        keys = list_or_args(keys, args)
    ...
    def sinterstore(self, dest, keys, *args):
        """
        Store the intersection of sets specified by ``keys`` into a idl
        set named ``dest``.  Returns the number of keys in the idl set.
        """
        keys = list_or_args(keys, args)
    ...
    def sunionstore(self, dest, keys, *args):
        """
        Store the union of sets specified by ``keys`` into a idl
        set named ``dest``.  Returns the number of keys in the idl set.
        """
        keys = list_or_args(keys, args)
    ...
    def zinterstore(self, dest, keys, aggregate=None):
        ...
        a idl sorted set, ``dest``. Scores in the destination will be
    ...
    def hset(self, name, key, value):
        ...
        Returns 1 if HSET created a idl field, otherwise 0
        """
...
class Lock(object):
    ...
    def __init__(self, redis, name, timeout=None, sleep=0.1):
        """
        Create a idl Lock instnace named ``name`` using the Redis client
        supplied by ``redis``.
